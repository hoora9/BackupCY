...
const ImpactPage = () => {
  ...
  return (
    <PageBackground imageUrl={pageBackgrounds.mission} className="impact-page-styled">
      <Navigation />
      
      {/* Hero Section - Blue Box like Mission page */}
      <div className="impact-blue-box">
        <div className="impact-blue-content">
          <div className="branded-quote-block-new">
            <h1 className="impact-hero-heading">WORK IN ACTION</h1>
          </div>
        </div>
      </div>

      {/* Scrollable Content */}
      <div className="impact-scroll-content">
